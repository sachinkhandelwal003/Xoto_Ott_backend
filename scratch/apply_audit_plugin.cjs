...
const modelsToAudit = [
  'Movie.ts', 'Show.ts', 'ShortDrama.ts', 'Episode.ts', 'Season.ts',
  'Actor.ts', 'Director.ts', 'Category.ts', 'Genre.ts', 'Language.ts',
  'User.ts', 'AdminUser.ts', 'SubscriptionPlan.ts', 'Crew.ts', 'Country.ts', 'Page.ts'
];
